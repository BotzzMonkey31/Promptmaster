<template>
  <div class="flex flex-col gap-4 p-4">
    <div class="flex justify-center mb-2">
      <div
        class="bg-white px-6 py-3 rounded-lg shadow text-3xl font-mono border border-gray-200 relative overflow-hidden"
      >
    ...
    <div class="flex items-start w-full gap-4">
      <img
        class="w-15 h-15 rounded-full border-2 border-red-500 shadow glitch-avatar"
        alt="Avatar"
        src="/assets/FaultyMascot.png"
      />
      <div
        class="flex-1 p-4 rounded-3 bg-white text-15px text-gray-800 shadow relative warning-bubble"
      >
        <div
...
const textBubble = ref(
  '⚠️ Warning: This AI system is known to be faulty and may introduce mistakes in its responses. Proceed with caution!',
)
